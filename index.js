...
const whitelist = ['http://167.172.136.248/',process.env.FRONTEND_URL,process.env.FRONTEND, process.env.BACKEND_URL, process.env.CLIENTE];
const corsOptions = {
...
app.listen(port, host, () => {
	console.log('el servidor está funcionando', port, host);
});