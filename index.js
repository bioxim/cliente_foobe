...
const whitelist = [process.env.FRONTEND_URL, process.env.BACKEND_URL, process.env.CLIENTE, 'http://167.172.151.137'];
const corsOptions = {
...
app.listen(port, host, () => {
	console.log('el servidor está funcionando en el puerto:', port, host);
});